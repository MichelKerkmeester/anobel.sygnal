"use strict";
(() => {
  // src/sygnal/Navigation.ts
  function sygnalNavigationScripts() {
    document.addEventListener("DOMContentLoaded", () => {
      ...
      if (!languageBtn || !languageDropdown || !languageIcon) {
        ...
        const toggleDropdown = (isOpen2) => {
          gsap.to(languageIcon, {
            rotation: isOpen2 ? 180 : 0,
            duration: 0.4,
            ease: "power2.out"
          });
          gsap.to(languageBtn, {
            backgroundColor: isOpen2 ? "var(--secondary--darkest)" : "var(--secondary--darker)",
            duration: 0.3
          });
          if (isOpen2) {
