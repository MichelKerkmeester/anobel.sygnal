...
export function sygnalNavigationScripts(): void {
  // Wrap everything in DOMContentLoaded to ensure elements exist before querying
  document.addEventListener("DOMContentLoaded", () => {
    // --------------------------------------------------
    // #region Hide Nav on Scroll (Script 1)
    // --------------------------------------------------
    let lastScrollTop = 0;
    ...
    // --------------------------------------------------
    // #region Mobile — Mega Menu (Script 2)
    // --------------------------------------------------
    // Select all elements
    ...
    // --------------------------------------------------
    // #region Language Selector (Script 4)
    // --------------------------------------------------
